...
export class InsertProductComponent implements OnInit {
  ...
  moveRight(){
    if (localStorage.getItem("user")) {
      if (this.productForm.get('productname').value !== '' && this.productForm.get('productdescription').value !== '' && this.productForm.get('prix').value !== '') {
        this.left = !this.left;
  ...
  otherNext(){
    if ((this.productForm.get('distric').value !== '' && this.productForm.get('city').value !== '' && this.productForm.get('region').value !== '') || (this.productForm.get('distric').value !== '' && this.productForm.get('city').value !== '' && this.productForm.get('region').value !== '' && this.productForm.get('pays').value !== '')) {
  ...
  submitInsertService(event){
    ...
    setTimeout(()=>{
      this.handlingservice.handlingInsertProduct(this.url,formData).subscribe(
        res => {
          console.log(res);
