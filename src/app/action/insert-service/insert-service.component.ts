...
export class InsertServiceComponent implements OnInit {
  ...
  public userid : any;
  constructor(private fb : FormBuilder,private handlingservice : HandlingDataService,private router: Router) { }
  ...
  moveRight(){
    if (localStorage.getItem("user")) {
      if (this.serviceForm.get('servicename').value !== '' && this.serviceForm.get('servicedescription').value !== '' && this.serviceForm.get('prix').value !== '') {
        this.left = !this.left;
  ...
  otherNext(){
    if ((this.serviceForm.get('distric').value !== '' && this.serviceForm.get('city').value !== '' && this.serviceForm.get('region').value !== '') || (this.serviceForm.get('distric').value !== '' && this.serviceForm.get('city').value !== '' && this.serviceForm.get('region').value !== '' && this.serviceForm.get('pays').value !== '')) {
